...
namespace {
    ...
    bool is_scheme(const char* s, const char* e)
    {
    ...
    bool is_scheme(const std::string& s) {
    ...
    bool is_reg_name(const char* s, const char* e) {
        return is_chars(s, e, 0x01);
    }


    bool is_reg_name(const std::string& s) {
    ...
    bool is_port(const char* s, const char* e) {
